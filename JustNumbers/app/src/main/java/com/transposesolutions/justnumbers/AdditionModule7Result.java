...
public class AdditionModule7Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition_module7_result);
        ...
        int score = Integer.parseInt(bundle.getString(AdditionModule7.GAME_MESSAGE1));
        String clockTime = bundle.getString(AdditionModule7.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(AdditionModule7Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AdditionModule7Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(AdditionModule7Result.this,Addition.class);
            startActivity(intent);
        });
