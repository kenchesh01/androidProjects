...
public class Subtraction extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //Database
        ...
        // When user taps Expanded Method button navigate to the respective activity
        module_8.setOnClickListener(view -> {
            Intent intent = new Intent(this, SubtractionModule8.class);
            startActivity(intent);
        });

        // When user taps Equations button navigate to the respective activity
        module_7.setOnClickListener(view -> {
            Intent intent = new Intent(this, SubtractionModule7.class);
            startActivity(intent);
        });

        // When user taps Doubles button navigate to the respective activity
        module_6.setOnClickListener(view -> {
            Intent intent = new Intent(this, SubtractionModule6.class);
            startActivity(intent);
        });

        // When user taps 3 Addends button navigate to the respective activity
        module_5.setOnClickListener(view -> {
            Intent intent = new Intent(this, SubtractionModule5.class);
            startActivity(intent);
        });

        // When user taps 3-Digits button navigate to the respective activity
        module_4.setOnClickListener(view -> {
            Intent intent = new Intent(this, SubtractionModule4.class);
            startActivity(intent);
        });

        // When user taps 3-Digits and 2-Digits button navigate to the respective activity
        module_3.setOnClickListener(view -> {
            Intent intent = new Intent(this, SubtractionModule3.class);
            startActivity(intent);
        });

        // When user taps 2-Digits button navigate to the respective activity
        module_2.setOnClickListener(view -> {
            Intent intent = new Intent(this, SubtractionModule2.class);
            startActivity(intent);
        });

        // When user taps 2-Digits and 1-Digit button navigate to the respective activity
        module_1.setOnClickListener(view -> {
            Intent intent = new Intent(this, SubtractionModule1.class);
            startActivity(intent);
        });
