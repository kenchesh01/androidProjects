...
public class MultiplicationModule7Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_module7_result);
        ...
        int score = Integer.parseInt(bundle.getString(MultiplicationModule7.GAME_MESSAGE1));
        String clockTime = bundle.getString(MultiplicationModule7.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(MultiplicationModule7Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MultiplicationModule7Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(MultiplicationModule7Result.this, Multiplication.class);
            startActivity(intent);
        });
