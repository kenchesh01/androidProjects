...
public class AdditionModule7 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition_module7);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(AdditionModule7.this, AdditionModule7Result.class);
    ...
    private void  updateQuestion() {
        ...
        num1 = 1 + random.nextInt(50);
        num2 = 1 + random.nextInt(10);
        num3 = num1 + num2;
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(AdditionModule7.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(AdditionModule7.this, Addition.class);
                startActivity(intent);
            });
