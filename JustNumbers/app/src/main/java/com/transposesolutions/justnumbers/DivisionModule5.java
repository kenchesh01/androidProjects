...
public class DivisionModule5 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_division_module5);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(DivisionModule5.this, DivisionModule5Result.class);
    ...
    private void  updateQuestion() {
        ...
        if(mQuestionNumber<NumberOfQns) {
            ...
            int placeValue = 1 + random.nextInt(3);
            if(placeValue==1)
            {
                int mNumberRange = 1 + random.nextInt(9);
                num1 = mNumberRange * 10;
                num2 = mNumberRange;
            }
            else if (placeValue==2){
                int mNumberRange = 1 + random.nextInt(9);
                num1 = mNumberRange * 100;
                num2 = mNumberRange;
            }
            else {
                int mNumberRange = 1 + random.nextInt(9);
                num1 = mNumberRange * 1000;
                num2 = mNumberRange;
            }
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DivisionModule5.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(DivisionModule5.this, Division.class);
                startActivity(intent);
            });
