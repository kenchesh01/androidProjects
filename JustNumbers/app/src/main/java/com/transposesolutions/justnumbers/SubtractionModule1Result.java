...
public class SubtractionModule1Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_module1_result);
        ...
        int score = Integer.parseInt(bundle.getString(SubtractionModule1.GAME_MESSAGE1));
        String clockTime = bundle.getString(SubtractionModule1.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(SubtractionModule1Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(SubtractionModule1Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(SubtractionModule1Result.this, Subtraction.class);
            startActivity(intent);
        });
