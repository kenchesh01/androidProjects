...
public class Multiplication extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
// check the data table empty or not
        ...
        // When user taps Multiply 3-digits by 1-digit button navigate to the respective activity
        module_8.setOnClickListener(view -> {
            Intent intent = new Intent(this, MultiplicationModule8.class);
            startActivity(intent);
        });

        // When user taps Multiply 2-digits by 1-digit button navigate to the respective activity
        module_7.setOnClickListener(view -> {
            Intent intent = new Intent(this, MultiplicationModule7.class);
            startActivity(intent);
        });

        // When user taps Multiply 3 or more numbers button navigate to the respective activity
        module_6.setOnClickListener(view -> {
            Intent intent = new Intent(this, MultiplicationModule6.class);
            startActivity(intent);
        });

        // When user taps Multiplying by Tens button navigate to the respective activity
        module_5.setOnClickListener(view -> {
            Intent intent = new Intent(this, MultiplicationModule5.class);
            startActivity(intent);
        });

        // When user taps Multiples of 7,8,9 button navigate to the respective activity
        module_4.setOnClickListener(view -> {
            Intent intent = new Intent(this, MultiplicationModule4.class);
            startActivity(intent);
        });

        // When user taps Multiples of 5 and 10 button navigate to the respective activity
        module_3.setOnClickListener(view -> {
            Intent intent = new Intent(this, MultiplicationModule3.class);
            startActivity(intent);
        });

        // When user taps Multiples of 3 and 6 button navigate to the respective activity
        module_2.setOnClickListener(view -> {
            Intent intent = new Intent(this, MultiplicationModule2.class);
            startActivity(intent);
        });

        // When user taps Multiples of 2 and 4 button navigate to the respective activity
        module_1.setOnClickListener(view -> {
            Intent intent = new Intent(this, MultiplicationModule1.class);
            startActivity(intent);
        });
