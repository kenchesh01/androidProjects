...
public class SubtractionModule3Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_module3_result);
        ...
        int score = Integer.parseInt(bundle.getString(SubtractionModule3.GAME_MESSAGE1));
        String clockTime = bundle.getString(SubtractionModule3.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(SubtractionModule3Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(SubtractionModule3Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(SubtractionModule3Result.this, Subtraction.class);
            startActivity(intent);
        });
