...
public class SubtractionModule6 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_module6);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(SubtractionModule6.this, SubtractionModule6Result.class);
    ...
    private void  updateQuestion() {
        ...
        num1 = 1 + random.nextInt(49);
        num2 = num1 * 2;
        String mTopAddend1 = Integer.toString(num2);
        topAddend1.setText(mTopAddend1);
        String mTopAddend2 = Integer.toString(num1);
    ...
    private String gameValidation() {
        topAddend1 = findViewById(R.id.top_addend1);
        topAddend2 = findViewById(R.id.top_addend2);
        int mTopAddend1 = Integer.parseInt(topAddend1.getText().toString());
        int mTopAddend2 = Integer.parseInt(topAddend2.getText().toString());
        int sumAddend = mTopAddend1 - mTopAddend2;
    ...
    private void updateGame() {
        ...
        userDataTable.setTopAddend1(num2);
        userDataTable.setTopAddend2(num1);
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(SubtractionModule6.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(SubtractionModule6.this, Subtraction.class);
                startActivity(intent);
            });
