...
public class SubtractionModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_module2);
...
//            mUserInput.setText(answer);
        ...
        // display activity length by obtaining user selected value
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(SubtractionModule2.this, SubtractionModule2Result.class);
    ...
    private void  updateQuestion() {
        ...
        num1 = 50 + random.nextInt(50);
        num2 = 10 + random.nextInt(41);
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(SubtractionModule2.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(SubtractionModule2.this, Subtraction.class);
                startActivity(intent);
            });
