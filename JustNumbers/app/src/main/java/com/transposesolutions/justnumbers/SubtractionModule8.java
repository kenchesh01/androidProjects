...
public class SubtractionModule8 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView mUserInput, result, ScoreDisplay,topAddend1, topAddend2, topAddend3, bottomAddend1, bottomAddend2, bottomAddend3, clock, displayLength;
    ...
    int count=1, gameScore = 0, num1, num2, mTopOnes, mTopTens, mBottomOnes, mBottomTens,  QuestionNumbers=1, Qn =0;
    int Answer = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_module8);
        ...
        topAddend1 = findViewById(R.id.top_addend1);
        topAddend2 = findViewById(R.id.top_addend2);
        topAddend3 = findViewById(R.id.top_addend3);
        bottomAddend1 = findViewById(R.id.bottom_addend1);
        bottomAddend2 = findViewById(R.id.bottom_addend2);
        bottomAddend3 = findViewById(R.id.bottom_addend3);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(SubtractionModule8.this, SubtractionModule8Result.class);
    ...
    private void  updateQuestion() {
        ...
        mTopOnes = 5 + random.nextInt(9);
        mTopTens = mTopOnes * 10;
        mBottomOnes = 1 + random.nextInt(4);
        mBottomTens = mBottomOnes * 10;
        num1 = mTopTens + mTopOnes;
        num2 = mBottomTens + mBottomOnes;
        String mTopAddend1 = Integer.toString(num1);
        topAddend1.setText(mTopAddend1);
        String mTopAddend2 = Integer.toString(mTopTens);
        topAddend2.setText(mTopAddend2);
        String mTopAddend3 = Integer.toString(mTopOnes);
        topAddend3.setText(mTopAddend3);
        String mBottomAddend1 = Integer.toString(num2);
        bottomAddend1.setText(mBottomAddend1);
        String mBottomAddend2 = Integer.toString(mBottomTens);
        bottomAddend2.setText(mBottomAddend2);
        String mBottomAddend3 = Integer.toString(mBottomOnes);
        bottomAddend3.setText(mBottomAddend3);
        mUserInput.setText("");
    }
    ...
    private void updateGame() {
        ...
        userDataTable.setTopAddend1(num1);
        userDataTable.setTopAddend2(mTopTens);
        userDataTable.setTopAddend3(mTopOnes);
        userDataTable.setBottomAddend1(num2);
        userDataTable.setBottomAddend2(mBottomTens);
        userDataTable.setBottomAddend3(mBottomOnes);
    ...
    private void upDateReTryQuestions(int Qns) {
        ...
        if(Qns<size) {
            ...
            num1 = userDataTable1.getTopAddend1();
            mTopTens = userDataTable1.getTopAddend2();
            mTopOnes = userDataTable1.getTopAddend3();
            num2 = userDataTable1.getBottomAddend1();
            mBottomTens = userDataTable1.getBottomAddend2();
            mBottomOnes = userDataTable1.getBottomAddend3();
            String mTopAddends1 = Integer.toString(num1);
            String mTopAddends2 = Integer.toString(mTopTens);
            String mTopAddends3 = Integer.toString(mTopOnes);
            String mBottomAddends1 = Integer.toString(num2);
            String mBottomAddends2 = Integer.toString(mBottomTens);
            String mBottomAddends3 = Integer.toString(mBottomOnes);
            topAddend1.setText(mTopAddends1);
            topAddend2.setText(mTopAddends2);
            topAddend3.setText(mTopAddends3);
            bottomAddend1.setText(mBottomAddends1);
            bottomAddend2.setText(mBottomAddends2);
            bottomAddend3.setText(mBottomAddends3);
            mUserInput.setText("");
            retryMathProblems++;
        }
    }
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(SubtractionModule8.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(SubtractionModule8.this, Subtraction.class);
                startActivity(intent);
            });
