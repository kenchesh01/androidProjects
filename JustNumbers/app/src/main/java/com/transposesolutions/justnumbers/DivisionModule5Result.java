...
public class DivisionModule5Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_division_module5_result);
        ...
        int score = Integer.parseInt(bundle.getString(DivisionModule5.GAME_MESSAGE1));
        String clockTime = bundle.getString(DivisionModule5.GAME_MESSAGE2);
        ...
        UserDataTable[] reTryQuestions = DivisionModule5.myAppDataBase.myDao().retry();
        ...
        List<UserDataTable> users = DivisionModule5.myAppDataBase.myDao().getUsers1();
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(DivisionModule5Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(DivisionModule5Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(DivisionModule5Result.this,Division.class);
            startActivity(intent);
        });
