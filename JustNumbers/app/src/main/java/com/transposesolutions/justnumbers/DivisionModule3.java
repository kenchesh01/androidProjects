...
public class DivisionModule3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_division_module3);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(DivisionModule3.this, DivisionModule3Result.class);
    ...
    private void  updateQuestion() {
        ...
        int mTopAddend1 = 1 + random.nextInt(12);
        num1 = mTopAddend1 * 10;
        int mTopAddend2 = 1 + random.nextInt(2);
        num2 = mTopAddend2 * 5;
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DivisionModule3.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(DivisionModule3.this, Division.class);
                startActivity(intent);
            });
