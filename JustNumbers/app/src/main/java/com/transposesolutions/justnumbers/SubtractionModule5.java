...
public class SubtractionModule5 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_module5);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(SubtractionModule5.this, SubtractionModule5Result.class);
    ...
    private void upDateReTryQuestions(int Qns) {
        ...
        if(Qns<size) {
            ...
            String mAddends1 = Integer.toString(num1);
            String mAddends2 = Integer.toString(num2);
            String mAddends3 = Integer.toString(num3);
            topAddend1.setText(mAddends1);
            topAddend2.setText(mAddends2);
            topAddend3.setText(mAddends3);
            mUserInput.setText("");
            retryMathProblems++;
        }
    }
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(SubtractionModule5.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(SubtractionModule5.this, Subtraction.class);
                startActivity(intent);
            });
