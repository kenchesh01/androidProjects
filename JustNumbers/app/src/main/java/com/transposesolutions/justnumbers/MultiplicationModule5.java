...
public class MultiplicationModule5 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_module5);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(MultiplicationModule5.this, MultiplicationModule5Result.class);
    ...
    //Generate random number and assign the value to Top Addend1 and Top Addend2
    private void  updateQuestion() {
        Random random = new Random(); //instance of random class
        int mTopAddend1 = 1 + random.nextInt(99);
        num1 = mTopAddend1 * 10;
        int mTopAddend2 = 1 + random.nextInt(1);
        num2 = mTopAddend2 * 10;
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(MultiplicationModule5.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(MultiplicationModule5.this, Multiplication.class);
                startActivity(intent);
            });
