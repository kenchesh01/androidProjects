...
public class DivisionModule8 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_division_module8);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(DivisionModule8.this, DivisionModule8Result.class);
    ...
    private void  updateQuestion() {
        ...
        if(mQuestionNumber<NumberOfQns) {
            //Division Game - Top Addend 1
            String[] DivQuestions1 = new String[]{
                    "121","132","140","180","165","169","55","132","156","180",
                    "360","144","256","143","176","204","204","225","240","270",
                    "108","144","160","169","180","100","140","180","187","136",
                    "120","143","108","154","78","160","135","195","256","100",
                    "120","132","102","108","165","169","55","132","156","180",
                    "120","190","240","143","176","204","204","285","324","361",
                    "330","550","660","380","990","550","170","190","222","390",
                    "100","220","200","555","170","160","380","140","180","152",
                    "121","132","144","256","143","176","180","209","192","247",
                    "525","625","196","234","256","324","288","289","342","304"

            };
            //Division Game Bottom Addend
            String[] DivQuestions2 = new String[]{
                    "11","12","10","18","11","13","11","12","12","15",
                    "18","12","16","11","11","12","17","15","12","15",
                    "12","12","16","13","12","10", "14","12","17","8",
                    "12","11","12","11","13","16","15","13","16","10",
                    "10","12","17","18","11","13","11","12","12","15",
                    "30","19","20","11","11","12","17","19","18","19",
                    "30","50","30","19","30","50","17","19","11","13",
                    "10","40","25","11","10","16","19","20","10","19",
                    "11","12","12","16","11","11","18","19","12","19",
                    "15","25","14","13","16","18","16","17","18","16"
            };
            topAddend.setText(DivQuestions1[mQuestionNumber]);
            bottomAddend.setText(DivQuestions2[mQuestionNumber]);
        }
        mUserInput.setText("");
        mQuestionNumber++;
    }
    ...
    private String gameValidation() {
        num1 = Integer.parseInt(topAddend.getText().toString());
        num2 = Integer.parseInt(bottomAddend.getText().toString());
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DivisionModule8.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(DivisionModule8.this, Division.class);
                startActivity(intent);
            });
