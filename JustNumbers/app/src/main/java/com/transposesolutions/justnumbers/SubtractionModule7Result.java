...
public class SubtractionModule7Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_module7_result);
        ...
        int score = Integer.parseInt(bundle.getString(SubtractionModule7.GAME_MESSAGE1));
        String clockTime = bundle.getString(SubtractionModule7.GAME_MESSAGE2);
        ...
        for (UserDataTable userDataTable : users) {
            ...
            // data for column-2
            String problemSet = userDataTable.getTopAddend1() + Space1 + Operator + Space1 + a + Space1 + Operator + Space1 + userDataTable.getTopAddend3() + equalOperator;
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(SubtractionModule7Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(SubtractionModule7Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(SubtractionModule7Result.this, Subtraction.class);
            startActivity(intent);
        });
