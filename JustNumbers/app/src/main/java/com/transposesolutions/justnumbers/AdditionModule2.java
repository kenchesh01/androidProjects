...
public class AdditionModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition_module2);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(AdditionModule2.this, AdditionModule2Result.class);
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(AdditionModule2.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(AdditionModule2.this, Addition.class);
                startActivity(intent);
            });
