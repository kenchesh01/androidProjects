...
public class AdditionModule4Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition_module4_result);
        ...
        int score = Integer.parseInt(bundle.getString(AdditionModule4.GAME_MESSAGE1));
        String clockTime = bundle.getString(AdditionModule4.GAME_MESSAGE2);
        ...
        UserDataTable[] reTryQuestions = AdditionModule4.myAppDataBase.myDao().retry();
        ...
        for (UserDataTable userDataTable : users) {
            ...
            // data for column-2
            String problemSet = userDataTable.getTopAddend() + Space1 + Operator + Space1 + userDataTable.getBottomAddend() + equalOperator;
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(AdditionModule4Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AdditionModule4Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(AdditionModule4Result.this,Addition.class);
            startActivity(intent);
        });
