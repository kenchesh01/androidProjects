...
public class MultiplicationModule6Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_module6_result);
        ...
        int score = Integer.parseInt(bundle.getString(MultiplicationModule6.GAME_MESSAGE1));
        String clockTime = bundle.getString(MultiplicationModule6.GAME_MESSAGE2);
        ...
        for (UserDataTable userDataTable : users) {
            ...
            // data for column-2
            String problemSet = userDataTable.getTopAddend1() + Space1 + Operator + Space1 + userDataTable.getTopAddend2() + Space1 + Operator + Space1 + userDataTable.getTopAddend3() + equalOperator;
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(MultiplicationModule6Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MultiplicationModule6Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(MultiplicationModule6Result.this, Multiplication.class);
            startActivity(intent);
        });
