...
public class AdditionModule1Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition_module1_result);
        ...
        Window window = AdditionModule1Result.this.getWindow();
        ...
        int score = Integer.parseInt(bundle.getString(AdditionModule1.GAME_MESSAGE1));
        String clockTime = bundle.getString(AdditionModule1.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(AdditionModule1Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AdditionModule1Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(AdditionModule1Result.this,Addition.class);
            startActivity(intent);
        });
