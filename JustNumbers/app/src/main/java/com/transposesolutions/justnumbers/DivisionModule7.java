...
public class DivisionModule7 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_division_module7);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(DivisionModule7.this, DivisionModule7Result.class);
    ...
    private void  updateQuestion() {
        ...
        if(mQuestionNumber<NumberOfQns) {
            ...
            String[] DivQuestions1 = new String[]{
                    "10","28","24","48","44","52","64","36","51","66",
                    "32","34","90","85","88","57","60","95","65","75",
                    "22","28","32","20","34","26","24","36","38","44",
                    "40","42","44","33","48","44","50","52","44","40",
                    "48","55","68","66","60","66","66","54","52","54",
                    "70","72","70","72","74","77","68","56","56","80",
                    "84","88","88","44","88","80","40","80","96","90",
                    "99","92","90","88","98","84","96","62","52","70",
                    "72","70","60","44","50","52","68","56","56","80",
                    "84","55","52","64","36","95","90","84","96","84"


            };
            //Division - Bottom Addend
            String[] DivQuestions2 = new String[]{
                    "10","14","12","12","11","13","16","12","17","11",
                    "16","17","18","17","11","19","12","19","13","15",
                    "11","14","16","10","17","13","12","18","19","11",
                    "10","21","22","11","12","11","10","13","22","20",
                    "24","11","17","11","12","22","33","18","26","27",
                    "10","12","35","18","37","11","34","28","14","10",
                    "14","11","44","22","44","40","20","40","12","45",
                    "11","46","18","22","49","12","24","31","26","10",
                    "12","35","10","11","10","13","34","28","14","10",
                    "14","11","13","16","12","19","18","14","12","12"
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DivisionModule7.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(DivisionModule7.this, Division.class);
                startActivity(intent);
            });
