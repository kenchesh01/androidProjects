...
public class AdditionModule5Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition_module5_result);
        ...
        int score = Integer.parseInt(bundle.getString(AdditionModule5.GAME_MESSAGE1));
        String clockTime = bundle.getString(AdditionModule5.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(AdditionModule5Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AdditionModule5Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(AdditionModule5Result.this,Addition.class);
            startActivity(intent);
        });
