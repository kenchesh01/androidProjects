...
public class MultiplicationModule6 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView mUserInput, result, ScoreDisplay, topAddend1, topAddend2, topAddend3, clock, displayLength;
    ...
    int count=1, gameScore = 0, num1, num2, num3, QuestionNumbers=1, Qn =0;
    int Answer = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_module6);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(MultiplicationModule6.this, MultiplicationModule6Result.class);
    ...
    private void  updateQuestion() {
        ...
        num1 = 1 + random.nextInt(10);
        num2 = 1 + random.nextInt(3);
        num3 = 2 + random.nextInt(4);
        String topAddends1 = Integer.toString(num1);
        topAddend1.setText(topAddends1);
        String topAddends2 = Integer.toString(num2);
        topAddend2.setText(topAddends2);
        String topAddends3 = Integer.toString(num3);
        topAddend3.setText(topAddends3);
        mUserInput.setText("");
    }

    //to validate the user input, add top addend (num1) + bottom addend (num2)
    private String gameValidation() {
        int sumAddend = num1 * num2 * num3;
    ...
    private void updateGame() {
        ...
        userDataTable.setTopAddend3(num3);
    ...
    private void upDateReTryQuestions(int Qns) {
        ...
        if(Qns<size) {
            ...
            num3 = userDataTable1.getTopAddend3();
            String mTopAddends1 = Integer.toString(num1);
            String mTopAddends2 = Integer.toString(num2);
            String mTopAddends3 = Integer.toString(num3);
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(MultiplicationModule6.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(MultiplicationModule6.this, Multiplication.class);
                startActivity(intent);
            });
