...
public class MultiplicationModule2Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_module2_result);
        ...
        int score = Integer.parseInt(bundle.getString(MultiplicationModule2.GAME_MESSAGE1));
        String clockTime = bundle.getString(MultiplicationModule2.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(MultiplicationModule2Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MultiplicationModule2Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(MultiplicationModule2Result.this, Multiplication.class);
            startActivity(intent);
        });
