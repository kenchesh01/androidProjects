...
public class MultiplicationModule8Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    Button mRetryButton, mHomeButton, mRedoButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_module8_result);
        ...
        int score = Integer.parseInt(bundle.getString(MultiplicationModule8.GAME_MESSAGE1));
        String clockTime = bundle.getString(MultiplicationModule8.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(MultiplicationModule8Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MultiplicationModule8Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(MultiplicationModule8Result.this, Multiplication.class);
            startActivity(intent);
        });
