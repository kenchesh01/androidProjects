...
public class MultiplicationModule1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_module1);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(MultiplicationModule1.this, MultiplicationModule1Result.class);
    ...
    private void  updateQuestion() {
        ...
        int mTopAddend1 = 1 + random.nextInt(2);
        num1 = mTopAddend1 * 2;
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(MultiplicationModule1.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(MultiplicationModule1.this, Multiplication.class);
                startActivity(intent);
            });
