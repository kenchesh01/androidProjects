...
public class AdditionModule2Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition_module2_result);
       ...
       myAppDataBase.myDao().deleteTable1(userDataTable);
        ...
        int score = Integer.parseInt(bundle.getString(AdditionModule2.GAME_MESSAGE1));
        String clockTime = bundle.getString(AdditionModule2.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(AdditionModule2Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AdditionModule2Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(AdditionModule2Result.this,Addition.class);
            startActivity(intent);
        });
