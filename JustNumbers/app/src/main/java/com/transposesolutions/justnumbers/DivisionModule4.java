...
public class DivisionModule4 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView mUserInput, result, ScoreDisplay,topAddend1, topAddend2, clock, displayLength;
    ...
    int count=1, gameScore = 0, num1,num2,  QuestionNumbers=1, Qn =0, mQuestionNumber=0;
    int Answer = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_division_module4);
...
//            mUserInput.setText(answer);
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(DivisionModule4.this, DivisionModule4Result.class);
    ...
    private void  updateQuestion() {
        ...
        // display activity length
        int NumberOfQns =appTracker.getNumberOfQuestions();
        if(mQuestionNumber<NumberOfQns) {
            //Division - Top Addends /
            String[] DivQuestions1 = new String[]{
                    "14", "21", "8", "16", "18", "21", "24", "27", "28", "32",
                    "35", "36", "40", "42", "45", "48", "49", "54", "56", "56",
                    "63", "64", "70", "72", "63", "72", "77", "7", "84", "81",
                    "96", "91", "88", "99", "9", "98", "80", "81", "54", "60",
                    "104", "105", "108", "117", "112", "112", "120", "119", "126", "126",
                    "133", "128", "136", "135", "144", "140", "147", "144", "152", "154",
                    "153", "49", "64", "81", "88", "108", "99", "77", "96", "84",
                    "21", "24", "27", "28", "32", "36", "40", "14", "21", "27",
                    "54", "64", "72", "81", "90", "104", "112", "126", "112", "126",
                    "96", "91", "104", "105", "119", "126", "135", "144", "152", "162"
            };
            //Division - Bottom Addends /
            String[] DivQuestions2 = new String[]{
                    "7", "7", "8", "8", "9", "7", "8", "9", "7", "8",
                    "7", "9", "8", "7", "9", "8", "7", "9", "8", "7",
                    "7", "8", "7", "9", "9", "9", "7", "7", "7", "9",
                    "8", "7", "8", "9", "9", "7", "8", "9", "6", "6",
            ...
            topAddend1.setText(DivQuestions1[mQuestionNumber]);
            topAddend2.setText(DivQuestions2[mQuestionNumber]);
        }
        mUserInput.setText("");
        mQuestionNumber++;
    }
    ...
    private String gameValidation() {
        num1 = Integer.parseInt(topAddend1.getText().toString());
        num2 = Integer.parseInt(topAddend2.getText().toString());
    ...
    private void updateGame() {
        ...
        userDataTable.setTopAddend2(num2);
    ...
    private void upDateReTryQuestions(int Qns) {
        ...
        if(Qns<size) {
            ...
            num2 = userDataTable1.getTopAddend2();
            String printTopAddend1 = Integer.toString(num1);
            topAddend1.setText(printTopAddend1);
            String printTopAddend2 = Integer.toString(num2);
            topAddend2.setText(printTopAddend2);
            mUserInput.setText("");
            retryMathProblems++;
        }
    }
    ...
    public void onBackPressed() {
        ...
        if(mMistakeQuestions){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DivisionModule4.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1(userDataTable);
                Intent intent = new Intent(DivisionModule4.this, Division.class);
                startActivity(intent);
            });
