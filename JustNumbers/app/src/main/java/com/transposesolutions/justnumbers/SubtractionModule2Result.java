...
public class SubtractionModule2Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_module2_result);
        ...
        int score = Integer.parseInt(bundle.getString(SubtractionModule2.GAME_MESSAGE1));
        String clockTime = bundle.getString(SubtractionModule2.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(SubtractionModule2Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(SubtractionModule2Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(SubtractionModule2Result.this, Subtraction.class);
            startActivity(intent);
        });
