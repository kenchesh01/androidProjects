...
public class MultiplicationModule1Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_module1_result);
        ...
        int score = Integer.parseInt(bundle.getString(MultiplicationModule1.GAME_MESSAGE1));
        String clockTime = bundle.getString(MultiplicationModule1.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(MultiplicationModule1Result.this);
        } else {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MultiplicationModule1Result.this);
        ...
        builder.setPositiveButton("Ok", (dialog, id) -> {
            ...
            appTracker.setMistakeQuestions(true);
            myAppDataBase.myDao().deleteTable1(userDataTable);
            Intent intent = new Intent(MultiplicationModule1Result.this, Multiplication.class);
            startActivity(intent);
        });
