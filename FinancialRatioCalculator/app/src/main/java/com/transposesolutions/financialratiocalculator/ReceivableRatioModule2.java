...
public class ReceivableRatioModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receivable_ratio_module2);
        ...
        String activity_message_1 = bun.getString(ReceivableRatioModule1.RESULT);
        String activity_message_2 = bun.getString(ReceivableRatioModule1.DETAIL);
        double activity_message_3 = Double.parseDouble(bun.getString(ReceivableRatioModule1.USER_INPUT_1));
        double activity_message_4 = Double.parseDouble(bun.getString(ReceivableRatioModule1.USER_INPUT_2));
        double activity_message_5 = Double.parseDouble(bun.getString(ReceivableRatioModule1.USER_INPUT_3));
    ...
    public void activity_share(View view) {
        ...
        String shareBody = "Your Accounts Receivable Ratio: " + activity_result + ",\n"
                + "What does it mean? " + activity_detail + "\n"+ "\n"
                + "Your Input: " + "\n"
                + "Net Sales: " + activity_user_input_1 + ",\n"
                + "Beginning Accounts Receivable: " + activity_user_input_2 + ",\n"
                + "Ending Accounts Receivable: " + activity_user_input_3 + ".\n";
        String shareSub = "Your Accounts Receivable Ratio is calculated by Transpose Solutions: Android App - Financial Ratio Calculator";
