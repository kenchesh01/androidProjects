...
public class CashRatioModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cash_ratio_module2);
        ...
        String activity_message_1 = bun.getString(CashRatioModule1.RESULT);
        String activity_message_2 = bun.getString(CashRatioModule1.DETAIL);
        double activity_message_3 = Double.parseDouble(bun.getString(CashRatioModule1.USER_INPUT_1));
        double activity_message_4 = Double.parseDouble(bun.getString(CashRatioModule1.USER_INPUT_2));
        double activity_message_5 = Double.parseDouble(bun.getString(CashRatioModule1.USER_INPUT_3));
    ...
    public void activity_share(View view) {
        ...
        String shareBody = "Your Cash Ratio: " + activity_result + ",\n"
                + "What does it mean? " + activity_detail + "\n"+ "\n"
                + "Your Input: " + "\n"
                + "Cash Equivalents: " + activity_user_input_1 + ",\n"
                + "Marketable Securities: " + activity_user_input_2 + ",\n"
                + "Current Liabilities: " + activity_user_input_3 + ".\n";
        String shareSub = "Your Cash Ratio is calculated by Transpose Solutions: Android App - Financial Ratio Calculator";
