...
public class InvestmentRatioModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_investment_ratio_module2);
        ...
        String activity_message_1 = bun.getString(InvestmentRatioModule1.RESULT);
        String activity_message_2 = bun.getString(InvestmentRatioModule1.DETAIL);
        double activity_message_3 = Double.parseDouble(bun.getString(InvestmentRatioModule1.USER_INPUT_1));
        double activity_message_4 = Double.parseDouble(bun.getString(InvestmentRatioModule1.USER_INPUT_2));
        double activity_message_5 = Double.parseDouble(bun.getString(InvestmentRatioModule1.USER_INPUT_3));
    ...
    public void activity_share(View view) {
        ...
        String shareBody = "Your Return on Investment Ratio: " + activity_result + ",\n"
                + "What does it mean? " + activity_detail + "\n"+ "\n"
                + "Your Input: " + "\n"
                + "Net Income: " + activity_user_input_1 + ",\n"
                + "Total Shareholders Equity: " + activity_user_input_2 + ",\n"
                + "Total Long-term Liabilities: " + activity_user_input_3 + ".\n";
        String shareSub = "Your Return on Investment is calculated by Transpose Solutions: Android App - Financial Ratio Calculator";
