...
public class EquityRatioModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_equity_ratio_module2);
        ...
        String activity_message_1 = bun.getString(EquityRatioModule1.RESULT);
        String activity_message_2 = bun.getString(EquityRatioModule1.DETAIL);
        double activity_message_3 = Double.parseDouble(bun.getString(EquityRatioModule1.USER_INPUT_1));
        double activity_message_4 = Double.parseDouble(bun.getString(EquityRatioModule1.USER_INPUT_2));
    ...
    public void activity_share(View view) {
        ...
        String shareBody = "Your Equity Ratio: " + activity_result + ",\n"
                + "What does it mean? " + activity_detail + "\n"+ "\n"
                + "Your Input: " + "\n"
                + "Total Equity: " + activity_user_input_1 + ",\n"
                + "Total Assets: " + activity_user_input_2  + ".\n";
        String shareSub = "Your Equity Ratio is calculated by Transpose Solutions: Android App -Financial Ratio Calculator";
