...
public class WorkingRatioModule2 extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_working_ratio_module2);
        ...
        String activity_message_1 = bun.getString(WorkingRatioModule1.RESULT);
        String activity_message_2 = bun.getString(WorkingRatioModule1.DETAIL);
        double activity_message_3 = Double.parseDouble(bun.getString(WorkingRatioModule1.USER_INPUT_1));
        double activity_message_4 = Double.parseDouble(bun.getString(WorkingRatioModule1.USER_INPUT_2));
        double activity_message_5 = Double.parseDouble(bun.getString(WorkingRatioModule1.USER_INPUT_3));
    ...
    public void activity_share(View view) {
        ...
        String shareBody = "Your Net Working Capital Ratio: " + activity_result + ",\n"
                + "What does it mean? " + activity_detail + "\n"+ "\n"
                + "Your Input: " + "\n"
                + "Current Assets: " + activity_user_input_1 + ",\n"
                + "Current Liabilities: " + activity_user_input_2 + ",\n"
                + "Total Assets: " + activity_user_input_3 + ".\n";
        String shareSub = "Your Net Working Capital Ratio is calculated by Transpose Solutions: Android App - Financial Ratio Calculator";
