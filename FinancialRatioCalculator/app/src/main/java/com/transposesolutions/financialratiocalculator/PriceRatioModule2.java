...
public class PriceRatioModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

// declare instance variables required for the navigation drawer
private ActionBarDrawerToggle mToggle;

        TextView _message1, _message2, _message3, _message4, _message5, _message6;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_price_ratio_module2);
        ...
        _message6 = findViewById(R.id.result_6);
        // Retrieve the copied string from the other activity
        Bundle bun = getIntent().getExtras();
        String activity_message_1 = bun.getString(PriceRatioModule1.RESULT);
        String activity_message_2 = bun.getString(PriceRatioModule1.DETAIL);
        double activity_message_3 = Double.parseDouble(bun.getString(PriceRatioModule1.USER_INPUT_1));
        double activity_message_4 = Double.parseDouble(bun.getString(PriceRatioModule1.USER_INPUT_2));
        double activity_message_5 = Double.parseDouble(bun.getString(PriceRatioModule1.USER_INPUT_3));
        double activity_message_6 = Double.parseDouble(bun.getString(PriceRatioModule1.USER_INPUT_4));
        ...
        _message6.setText(String.format(Locale.getDefault(),"%,.2f",activity_message_6));
    }
    ...
    public void activity_share(View view) {
        ...
        String activity_user_input_4;
        activity_user_input_4 = _message6.getText().toString();
        // above declared string are exported to share activity
        Intent sharingIntent = new Intent(android.content.Intent.ACTION_SEND);
        sharingIntent.setType("text/plain");
        String shareBody = "Your Price to Earnings Ratio: " + activity_result + ",\n"
                + "What does it mean? " + activity_detail + "\n"+ "\n"
                + "Your Input: " + "\n"
                + "Share Price: " + activity_user_input_1 + ",\n"
                + "Net Income: " + activity_user_input_2 + ",\n"
                + "Preferred Dividends: " + activity_user_input_3 + ",\n"
                + "Shares Outstanding: " + activity_user_input_4 + ".\n";
        String shareSub = "Your Price to Earnings Ratio is calculated by Transpose Solutions: Android App - Financial Ratio Calculator";
