...
public class DebtEquityModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_debt_equity_module2);
        ...
        String activity_message_1 = bun.getString(DebtEquityModule1.RESULT);
        String activity_message_2 = bun.getString(DebtEquityModule1.DETAIL);
        double activity_message_3 = Double.parseDouble(bun.getString(DebtEquityModule1.USER_INPUT_1));
        double activity_message_4 = Double.parseDouble(bun.getString(DebtEquityModule1.USER_INPUT_2));
    ...
    public void activity_share(View view) {
        ...
        String shareBody = "Your Debt Equity Ratio: " + activity_result + ",\n"
                + "What does it mean? " + activity_detail + "\n"+ "\n"
                + "Your Input: " + "\n"
                + "Total Liabilities: " + activity_user_input_1 + ",\n"
                + "Total Equity: " + activity_user_input_2  + ".\n";
        String shareSub = "Your Debt Equity Ratio is calculated by Transpose Solutions: Android App - Financial Ratio Calculator";
