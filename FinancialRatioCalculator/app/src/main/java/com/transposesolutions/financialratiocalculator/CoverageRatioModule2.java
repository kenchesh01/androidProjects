...
public class CoverageRatioModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    // declare instance variables required for the navigation drawer
    private ActionBarDrawerToggle mToggle;
    TextView _message1, _message2, _message3, _message4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_coverage_ratio_module2);
        ...
        String activity_message_1 = bun.getString(CoverageRatioModule1.RESULT);
        String activity_message_2 = bun.getString(CoverageRatioModule1.DETAIL);
        double activity_message_3 = Double.parseDouble(bun.getString(CoverageRatioModule1.USER_INPUT_1));
        double activity_message_4 = Double.parseDouble(bun.getString(CoverageRatioModule1.USER_INPUT_2));
    ...
    public void activity_share(View view) {
        ...
        String shareBody = "Your Interest Coverage Ratio: " + activity_result + ",\n"
                + "What does it mean? " + activity_detail + "\n"+ "\n"
                + "Your Input: " + "\n"
                + "Earnings Before Interest and Tax: " + activity_user_input_1 + ",\n"
                + "Interest Expense: " + activity_user_input_2 + ".\n";
        String shareSub = "Your Interest Coverage Ratio is calculated by Transpose Solutions: Android App -Financial Ratio Calculator";
