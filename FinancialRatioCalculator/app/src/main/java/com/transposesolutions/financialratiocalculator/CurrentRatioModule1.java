...
public class CurrentRatioModule1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_ratio_module1);
        ...
        buttonCalculate.setOnClickListener(view -> {
            ...
            //check for required minimum value
                ...
                current_ratio = Math.round(current_ratio * 100.0)/100.0;
                System.out.println(current_ratio);
                String _result =(current_ratio + " : 1");
                // steps to display result details
                double result_detail = (current_assets / current_liabilities);
                result_detail = Math.round(result_detail * 100.0)/100.0;
                System.out.println(result_detail);
                String _detail =   "Based on the above result, company has a Current ratio of "
                        + current_ratio + " : 1. It means $"
                        + result_detail + " of current assets is available to cover each $1 of its current liabilities" ;

                // Method used to copy the above declared strings from this activity and forward it to another activity
                Intent intent = new Intent(CurrentRatioModule1.this, CurrentRatioModule2.class);
    ...
    private void requiredCheck1() {
        AlertDialog.Builder builder = new AlertDialog.Builder(CurrentRatioModule1.this);
    ...
    private void requiredCheck2() {
        AlertDialog.Builder builder = new AlertDialog.Builder(CurrentRatioModule1.this);
        builder.setMessage("Current liability value must be at least 100 or greater value")
                .setCancelable(false)
                .setPositiveButton("OK", (dialog, i) -> {
                });
        AlertDialog alertDialog = builder.create();
    ...
    public void activity_reset(View view) {
        Intent intent = new Intent(this, CurrentRatioModule1.class);
        startActivity(intent);
    }
}