...
public class GrossMarginModule2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gross_margin_module2);
        ...
        String activity_message_1 = bun.getString(GrossMarginModule1.RESULT);
        String activity_message_2 = bun.getString(GrossMarginModule1.DETAIL);
        double activity_message_3 = Double.parseDouble(bun.getString(GrossMarginModule1.USER_INPUT_1));
        double activity_message_4 = Double.parseDouble(bun.getString(GrossMarginModule1.USER_INPUT_2));
    ...
    public void activity_share(View view) {
        ...
        String shareBody = "Your Gross Profit Margin: " + activity_result + ",\n"
                + "What does it mean? " + activity_detail + "\n"+ "\n"
                + "Your Input: " + "\n"
                + "Net Sales: " + activity_user_input_1 + ",\n"
                + "Cost of Goods (COGS): " + activity_user_input_2 +  ".\n";
        String shareSub = "Your Gross Profit Margin is calculated by Transpose Solutions: Android App - Financial Ratio Calculator";
