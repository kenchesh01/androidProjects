...
public class PlaneAngle extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//        // set listeners
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.spinner_plane_angle_items, R.layout.spinner_selector_items);
        ...
        selector_1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position==0){
                    ...
                    update_Minute_of_arc();
                }else if(position==4){
                    update_Radian();
                }else if(position==5){
                    update_Second_of_arc();
                }else if(position==6){
                    update_Turn();
                }
            }
    ...
    private void update_degree() {
        ...
        double valueSelector5 =  (userValue1 *  200/180);
        String _valueSelector5 = decimalFormat.format(valueSelector5);
        result2.setText(_valueSelector5);
        // Degree  to  MilliRadian

        double valueSelector6 =  (userValue1 * (1000*3.1415)/180);
        String _valueSelector6 = decimalFormat.format(valueSelector6);
        result3.setText(_valueSelector6);
        // Degree  to Minute_of_arc

        int valueSelector7 = (int) (userValue1 * 60);
        String _valueSelector7 = decimalFormat.format(valueSelector7);
        result4.setText(_valueSelector7);
        // Degree  to Radian

        double valueSelector8 = (userValue1 * 3.1415/180);
        String _valueSelector8 = decimalFormat.format(valueSelector8);
        result5.setText(_valueSelector8);
        // Degree  to  Second_of_arc

        int  valueSelector9 = (int) (userValue1 * 3600);
        String _valueSelector9 = decimalFormat.format(valueSelector9);
        result6.setText(_valueSelector9);

        // Degree  to  Turn

        double valueSelector15 =  (userValue1 /360);
        String _valueSelector15 = decimalFormat.format(valueSelector15);
        result7.setText(_valueSelector15);

    }


    private void update_GraDian() {
        // GraDian  to Degree

        double valueSelector1 = (userValue1 * 180/200 );
        String _valueSelector1 = decimalFormat.format(valueSelector1);
        result1.setText(_valueSelector1);
        ...
        double valueSelector6 =  (userValue1 * (1000*3.1415)/200 );
        String _valueSelector6 = decimalFormat.format(valueSelector6);
        result3.setText(_valueSelector6);
        // GraDian  to Minute_of_arc

        int valueSelector7 = (int) (userValue1 * 54);
        String _valueSelector7 = decimalFormat.format(valueSelector7);
        result4.setText(_valueSelector7);
        // GraDian  to Radian

        double valueSelector8 = (userValue1 * 3.1415/200);
        String _valueSelector8 = decimalFormat.format(valueSelector8);
        result5.setText(_valueSelector8);
        // GraDian  to  Second_of_arc

        int valueSelector9 = (int) (userValue1 * 3240);
        String _valueSelector9 = decimalFormat.format(valueSelector9);
        result6.setText(_valueSelector9);
        ...
        double valueSelector15 =  (userValue1 /400);
        String _valueSelector15 = decimalFormat.format(valueSelector15);
        result7.setText(_valueSelector15);

    }

    private void update_MilliRadian() {
        // MilliRadian  to Degree

        double valueSelector1 = (userValue1 * 180/(1000*3.1415) );
        String _valueSelector1 = decimalFormat.format(valueSelector1);
        result1.setText(_valueSelector1);

        // MilliRadian  to GraDian

        double valueSelector5 =  (userValue1 * 200/(1000*3.1415));
        String _valueSelector5 = decimalFormat.format(valueSelector5);
        result2.setText(_valueSelector5);
        // MilliRadian  to  MilliRadian

        double valueSelector6 =  (userValue1 * 1);
        String _valueSelector6 = decimalFormat.format(valueSelector6);
        result3.setText(_valueSelector6);
        // MilliRadian  to Minute_of_arc

        double valueSelector7 =  (userValue1 *(60 * 180)/(1000*3.1415));
        String _valueSelector7 = decimalFormat.format(valueSelector7);
        result4.setText(_valueSelector7);
        // MilliRadian  to Radian

        double valueSelector8 = (userValue1 /1000);
        String _valueSelector8 = decimalFormat.format(valueSelector8);
        result5.setText(_valueSelector8);
        // MilliRadian  to  Second_of_arc

        double valueSelector9 =  (userValue1 * (3600 * 180)/(1000*3.1415));
        String _valueSelector9 = decimalFormat.format(valueSelector9);
        result6.setText(_valueSelector9);
        ...
        double valueSelector15 =  (userValue1 /(2000*3.1415));
        String _valueSelector15 = decimalFormat.format(valueSelector15);
        result7.setText(_valueSelector15);

    }

    private void update_Minute_of_arc() {
        // Minute_of_arc  to Degree

        double valueSelector1 = (userValue1 /60 );
        String _valueSelector1 = decimalFormat.format(valueSelector1);
        result1.setText(_valueSelector1);

        // Minute_of_arc  to GraDian

        double valueSelector5 =  (userValue1 /54);
        String _valueSelector5 = decimalFormat.format(valueSelector5);
        result2.setText(_valueSelector5);
        // Minute_of_arc  to  MilliRadian

        double valueSelector6 =  (userValue1 * (1000*3.1415)/(60 * 180) );
        String _valueSelector6 = decimalFormat.format(valueSelector6);
        result3.setText(_valueSelector6);
        // Minute_of_arc  to Minute_of_arc

        double valueSelector7 =  (userValue1 * 1);
        String _valueSelector7 = decimalFormat.format(valueSelector7);
        result4.setText(_valueSelector7);
        // Minute_of_arc  to Radian

        double valueSelector8 = (userValue1 * 3.1415/(60 * 180));
        String _valueSelector8 = decimalFormat.format(valueSelector8);
        result5.setText(_valueSelector8);
        // Minute_of_arc  to  Second_of_arc

        double valueSelector9 =  (userValue1 * 60 );
        String _valueSelector9 = decimalFormat.format(valueSelector9);
        result6.setText(_valueSelector9);

        // Minute_of_arc  to  turn
        double valueSelector15 = (userValue1 * 4.6296e-5);
        String _valueSelector15 = decimalScientificFormat.format(valueSelector15);
        result7.setText(_valueSelector15);

    }

    private void update_Radian() {
        // Radian  to Degree

        double valueSelector1 = (userValue1 * 180/3.1415 );
        String _valueSelector1 = decimalFormat.format(valueSelector1);
        result1.setText(_valueSelector1);

        // Radian  to GraDian

        double valueSelector5 =  (userValue1 *  200/3.1415);
        String _valueSelector5 = decimalFormat.format(valueSelector5);
        result2.setText(_valueSelector5);
        ...
        String _valueSelector6 = decimalFormat.format(valueSelector6);
        result3.setText(_valueSelector6);
        // Radian  to Minute_of_arc

        double valueSelector7 =  (userValue1 *  (60 * 180)/3.1415);
        String _valueSelector7 = decimalFormat.format(valueSelector7);
        result4.setText(_valueSelector7);
        // Radian  to Radian

        double valueSelector8 = (userValue1 * 1);
        String _valueSelector8 = decimalFormat.format(valueSelector8);
        result5.setText(_valueSelector8);
        // Radian  to  Second_of_arc

        double valueSelector9 =  (userValue1 *  (3600 * 180)/3.1415 );
        String _valueSelector9 = decimalFormat.format(valueSelector9);
        result6.setText(_valueSelector9);
        // Radian  to  turn

        double valueSelector15 =  (userValue1 /(2*3.1415));
        String _valueSelector15 = decimalFormat.format(valueSelector15);
        result7.setText(_valueSelector15);

    }

    private void update_Second_of_arc() {
        // Second_of_arc  to Degree

        double valueSelector1 = (userValue1 /3600 );
        String _valueSelector1 = decimalFormat.format(valueSelector1);
        result1.setText(_valueSelector1);
        // Second_of_arc  to GraDian

        double valueSelector5 =  (userValue1 /3240);
        String _valueSelector5 = decimalFormat.format(valueSelector5);
        result2.setText(_valueSelector5);
        // Second_of_arc  to  MilliRadian

        double valueSelector6 =  (userValue1 * (1000*3.1415)/(180 *3600) );
        String _valueSelector6 = decimalFormat.format(valueSelector6);
        result3.setText(_valueSelector6);
        // Second_of_arc  to Minute_of_arc

        double valueSelector7 =  (userValue1 /60);
        String _valueSelector7 = decimalFormat.format(valueSelector7);
        result4.setText(_valueSelector7);
        // Second_of_arc  to Radian

        double valueSelector8 = (userValue1 * 3.1415/(180 * 3600));
        String _valueSelector8 = decimalScientificFormat.format(valueSelector8);
        result5.setText(_valueSelector8);
        // Second_of_arc  to  Second_of_arc

        double valueSelector9 =  (userValue1 * 1 );
        String _valueSelector9 = decimalFormat.format(valueSelector9);
        result6.setText(_valueSelector9);

        // Second_of_arc  to  Turn

        double valueSelector15 =  (userValue1 * 7.716e-7);
        String _valueSelector15 = decimalScientificFormat.format(valueSelector15);
        result7.setText(_valueSelector15);
    ...
    private void update_Turn() {
        // Turn  to Degree
        int valueSelector1 = (int) (userValue1 * 360);
        String _valueSelector1 = decimalFormat.format(valueSelector1);
        result1.setText(_valueSelector1);
        // Turn  to GraDian

        int valueSelector5 = (int) (userValue1 * 400);
        String _valueSelector5 = decimalFormat.format(valueSelector5);
        result2.setText(_valueSelector5);
        // Turn  to  MilliRadian

        double valueSelector6 =  (userValue1 *(2000*3.1415));
        String _valueSelector6 = decimalFormat.format(valueSelector6);
        result3.setText(_valueSelector6);
        // Turn  to Minute_of_arc

        int valueSelector7 = (int) (userValue1 * 21600);
        String _valueSelector7 = decimalFormat.format(valueSelector7);
        result4.setText(_valueSelector7);
        // Turn  to Radian

        double valueSelector8 = (userValue1 * (2*3.1415));
        String _valueSelector8 = decimalFormat.format(valueSelector8);
        result5.setText(_valueSelector8);
        // Turn  to  Second_of_arc

        double valueSelector9 =  (userValue1 * 1.296e+6);
    ...
    private void shareUpdate() {
        ...
        String shareBody =   "Results based on your input for "+ User_enter_data + " " +selectedItem + "\n"
                + "Degree (o)  : " + activity_result  + "\n"
                + "GraDian (^g): " + activity_result2 + "\n"
                + "MilliRadian: " + activity_result3 + "\n"
                + "Minute of arc:" + activity_result4+ "\n"
                + "Radian (rad): " + activity_result5 + "\n"
                + "Second of arc : " + activity_result6 + "\n"
                + "Turn : " + activity_result7  + "\n";

        String shareSub = "Plane Angle Converter Results Powered by Transpose Solutions Android App - Unit Converter ";
