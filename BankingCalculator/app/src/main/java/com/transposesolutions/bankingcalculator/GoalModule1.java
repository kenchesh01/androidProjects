...
public class GoalModule1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    private ActionBarDrawerToggle mToggle;
    private AdView adView;
    // declare package prefix , GOAL_MESSAGE constant and key values
    public final static String GOAL_MESSAGE1 = "com.transposesolutions.bankingcalculator.CONTRIBUTION";
    public final static String GOAL_MESSAGE1A = "com.transposesolutions.bankingcalculator.TOTAL_DEPOSIT";
    public final static String GOAL_MESSAGE2 = "com.transposesolutions.bankingcalculator.INTEREST";
    public final static String GOAL_MESSAGE3 = "com.transposesolutions.bankingcalculator.SAVINGS_GOAL";
    public final static String GOAL_MESSAGE4 = "com.transposesolutions.bankingcalculator.INITIAL_INVESTMENT";
    public final static String GOAL_MESSAGE5 = "com.transposesolutions.bankingcalculator.TIME_SAVE";
    public final static String GOAL_MESSAGE6 = "com.transposesolutions.bankingcalculator.INTEREST_RATE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goal_module1);
...
//        }
        ...
        calculateButton.setOnClickListener(new View.OnClickListener() {
            ...
            // Check for minimum and maximum required values and alert user with message to fix the required values
                ...
                Intent intent = new Intent(GoalModule1.this, GoalModule2.class);
                ...
                String TOTAL_DEPOSIT = String.valueOf(_totalDeposit);
                ...
                bundle.putString(GOAL_MESSAGE1, CONTRIBUTION);
                bundle.putString(GOAL_MESSAGE1A, TOTAL_DEPOSIT);
                bundle.putString(GOAL_MESSAGE2, INTEREST);
                bundle.putString(GOAL_MESSAGE3, GOAL);
                bundle.putString(GOAL_MESSAGE4, INVESTMENT);
                bundle.putString(GOAL_MESSAGE5, TIME);
                bundle.putString(GOAL_MESSAGE6, ROI);
    ...
    private void requiredCheck1() {
        AlertDialog.Builder builder = new AlertDialog.Builder(GoalModule1.this);
