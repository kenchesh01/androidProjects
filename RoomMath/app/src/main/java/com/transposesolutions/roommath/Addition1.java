...
public class Addition1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//        //Database
//        myAppDataBase = Room.databaseBuilder(getApplicationContext(),MyAppDatabase.class,"User")
...
//            mUserInput.setText(answer);
            if (mInput.equals("0") && mInput != null)
            {
        ...
        keyClear.setOnClickListener(v -> mUserInput.setText(" "));
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if(count<NumberOfQns){
                ...
                Intent intent = new Intent(Addition1.this, Addition1Result.class);
    ...
    public void onBackPressed() {
        ...
        if (mMistakeQuestions) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(Addition1.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                myAppDataBase.myDao().deleteTable1();
                Intent intent = new Intent(Addition1.this, MainActivity.class);
                startActivity(intent);
            });
