...
public class Addition2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mMistakeQuestions) {
            ...
            retryQuestions = Addition2.myAppDataBase.myDao().retry();
            Addition2.myAppDataBase.myDao().deleteTable1();
        ...
        checkAnswer.setOnClickListener(view -> {
            ...
            if (count < NumberOfQns) {
                ...
                Intent intent = new Intent(Addition2.this, Addition2Result.class);
    ...
    public void onBackPressed() {
        ...
        if (mMistakeQuestions) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(Addition2.this);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                Intent intent = new Intent(Addition2.this, MainActivity.class);
                startActivity(intent);
            });
