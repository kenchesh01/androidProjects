...
public class Addition2Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition2_result);
        ...
        Window window = Addition2Result.this.getWindow();
        ...
        mRetryButton.setOnClickListener(view -> {
            ...
            myAppDataBase.myDao().deleteTable1();
        ...
        int score = Integer.parseInt(bundle.getString(Addition2.GAME_MESSAGE1));
        String clockTime = bundle.getString(Addition2.GAME_MESSAGE2);
    ...
    //alled to display interstitial ad
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(Addition2Result.this);
        } else {
