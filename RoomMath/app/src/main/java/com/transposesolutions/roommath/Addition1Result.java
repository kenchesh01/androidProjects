...
public class Addition1Result extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition1_result);
        ...
        Window window = Addition1Result.this.getWindow();
        ...
        int score = Integer.parseInt(bundle.getString(Addition1.GAME_MESSAGE1));
        String clockTime = bundle.getString(Addition1.GAME_MESSAGE2);
    ...
    public void displayInterstitial() {
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.show(Addition1Result.this);
        } else {
